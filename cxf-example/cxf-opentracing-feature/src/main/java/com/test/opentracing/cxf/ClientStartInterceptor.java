...
public class ClientStartInterceptor extends AbstractClientInterceptor {

    public ClientStartInterceptor(final Tracer tracer) {
        super(Phase.PRE_STREAM, tracer);
    }

    public ClientStartInterceptor(final String phase, final Tracer tracer) {
        super(phase, tracer);
    }
